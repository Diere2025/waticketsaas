      ...
      >
        <TableHead>
          <TableRow>
            ...
            <TableCell align="left">Creada El</TableCell>
...
export default function CompaniesManager() {
  ...
  const handleSubmit = async (data) => {
    ...
    try {
      ...
      toast.error(
        "No fue posible realizar la operación. Verifique si ya existe una empresa con el mismo nombre o si los campos se llenaron correctamente"
      );
    }
    setLoading(false);
  };
  ...
  return (
    <Paper className={classes.mainPaper} elevation={0}>
      ...
      >
        ¿Realmente deesea eliminar este registro?
      </ConfirmationModal>
    </Paper>
  );
}
