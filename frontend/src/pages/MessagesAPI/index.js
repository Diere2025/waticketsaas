    ...
    >
      ...
      <Typography component="div">
        <ol>
          ...
          <li>Mensajes de Medios (Media)</li>
        </ol>
      </Typography>
      <Typography variant="h6" color="primary" className={classes.elementMargin}>
        Instrucciones
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          <li>Antes de enviar mensajes, es necesario registrar el token vinculado a la conexión que enviará los mensajes. <br />Para realizar el registro, acceda al menú "Conexiones", haga clic en el botón editar de la conexión e inserte el token en el campo correspondiente.</li>
          <li>
            El número para envío no debe tener máscara o caracteres especiales y debe estar compuesto por:
            <ul>
              <li>Código del país</li>
              <li>DDD (Cód. de Área)</li>
              <li>Número</li>
            </ul>
          </li>
        </ul>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            <p>A continuación se muestra la lista de información necesaria para enviar mensajes con archivos multimedia:</p>
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
