    ...
    <div onClick={drawerClose}>
        ...
        no={() => (
          <>
            <ListSubheader
              ...
              inset
              color="inherit">
              <Typography variant="overline" style={{ fontWeight: 'normal' }}>  {i18n.t("Atención")} </Typography>
            </ListSubheader>
            <>
        ...
        yes={() => (
          <>
            <ListSubheader
              ...
              <Typography variant="overline" style={{ fontWeight: 'normal' }}>  {i18n.t("Gerencia")} </Typography>
            </ListSubheader>
	  ...
	  <li>
        ...
        >
          ...
          <ListItemText primary={"Salir"} style={{ color: '#fff' }} />
        </ListItem>
      </li>
    </div>
  );
